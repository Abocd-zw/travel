...
public class Route implements Serializable {
    ...
    private int rid;//线路id，必�?
    private String rname;//线路名称，必�?
    private double price;//价格，必�?
    private String routeIntroduce;//线路介绍
    private String rflag;   //是否上架，必输，0代表没有上架�?1代表是上�?
    private String rdate;   //上架时间
    private String isThemeTour;//是否主题旅游，必输，0代表不是�?1代表�?
    private int count;//收藏数量
    private int cid;//�?属分类，必输
    private String rimage;//缩略�?
    private int sid;//�?属商�?
    private String sourceId;//抓取数据的来源id

    private Category category;//�?属分�?
    private Seller seller;//�?属商�?
